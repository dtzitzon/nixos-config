...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Demitri Tzitzon"
    user-mail-address "dtzitzon@anduril.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/dtzitzon/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/dtzitzon/bin" "/profile/bin" "/Users/dtzitzon/.npm-packages/bin" "/Users/dtzitzon/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
